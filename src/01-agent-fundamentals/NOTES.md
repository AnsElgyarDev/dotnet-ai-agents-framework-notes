...
> 
>      1. System Instructions (Personas): Defines explicit roles and system prompts (e.g., *"You are a Senior C# Backend Engineer..."*).
>      2. Tools & Function Calling: Empowers the model to invoke native C# methods, query database repositories, or read/write local files.
>      3. State & Memory Management (`AgentSession`): Maintains, inspects, and persists conversation history across multi-turn exchanges.
